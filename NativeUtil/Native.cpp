...
void rowReduce(double* Ab[], int M, int N)
{
    // Solve for dx.
...
extern "C" NATIVE_API double execute(
    int SampleCount,
    double t,
    double state[],
    double ins[],
    double outs[])
{
    ...
    {
        double num66 = (ins[sampleNumber] - num65) * 1.0;
        double d = 0.0;
        int oversample = 1;
        do
        {
            ...
            do
            {
                ...
                double num142 = log(x2);
                double x3 = (!flag2 ? x1 : num142) * (5.0 / 17.0);
                double num143 = pow(x3, 0.26);
                ...
                double num151 = log(x5);
                double x6 = (!flag5 ? x4 : num151) * 0.100999899000101;
                double num152 = pow(x6, 0.314);
                ...
                double num161 = log(x8);
                double x9 = (!flag8 ? x7 : num161) * 0.100999899000101;
                double num162 = pow(x9, 0.314);
                ...
                double num169 = pow(x6, 1.314) * 0.0006177;
                double num170 = -(!flag4 ? 0.0 : num169);
                double num171 = pow(x9, 1.314) * 0.0006177;
                double num172 = (!flag7 ? 0.0 : num171) * 1.13216848020515E-06;
                double num173 = pow(x3, 1.26) * 0.002242;
                ...
                double num257 = log(x11);
                double x12 = (!flag11 ? x10 : num257) * 0.100999899000101;
                double num258 = pow(x12, 0.314);
                ...
                numArray3[6] = 0.0;
                numArray3[7] = 0.0;
                double num261 = pow(x12, 1.314) * 0.0006177;
                ...
                double num270 = log(x14);
                double x15 = (!flag14 ? x13 : num270) * (5.0 / 17.0);
                double num271 = pow(x15, 0.26);
                ...
                double num281 = pow(x15, 1.26) * 0.002242;
                ...
                double num305 = log(x17);
                double x18 = (!flag17 ? x16 : num305) * (5.0 / 17.0);
                double num306 = pow(x18, 0.26);
                ...
                double num315 = log(x20);
                double x21 = (!flag20 ? x19 : num315) * 0.100999899000101;
                double num316 = pow(x21, 0.314);
                ...
                double num324 = pow(x21, 1.314) * 0.0006177;
                double num325 = pow(x18, 1.26) * 0.002242;
                ...
                double num344 = log(x23);
                double x24 = (!flag23 ? x22 : num344) * (5.0 / 17.0);
                double num345 = pow(x24, 0.26);
                ...
                double num353 = pow(x24, 1.26) * 0.002242;
                ...
                bool flag25 = true & abs(num405) * 10000.0 < abs(num129) + 1E-06;
                num129 += num405;
                bool flag26 = flag25 && abs(num421) * 10000.0 < abs(num127) + 1E-06;
                num127 += num421;
                bool flag27 = flag26 && abs(num474) * 10000.0 < abs(num125) + 1E-06;
                num125 += num474;
                bool flag28 = flag27 && abs(num529) * 10000.0 < abs(num124) + 1E-06;
                num124 += num529;
                bool flag29 = flag28 && abs(num578) * 10000.0 < abs(num122) + 1E-06;
                num122 += num578;
                bool flag30 = flag29 && abs(num623) * 10000.0 < abs(num121) + 1E-06;
                num121 += num623;
                bool flag31 = flag30 && abs(num670) * 10000.0 < abs(num117) + 1E-06;
                num117 += num670;
                bool flag32 = flag31 && abs(num698) * 10000.0 < abs(num89) + 1E-06;
                num89 += num698;
                bool flag33 = flag32 && abs(num715) * 10000.0 < abs(num119) + 1E-06;
                num119 += num715;
                bool flag34 = flag33 && abs(num716) * 10000.0 < abs(num118) + 1E-06;
                num118 += num716;
                bool flag35 = flag34 && abs(num725) * 10000.0 < abs(num116) + 1E-06;
                num116 += num725;
                bool flag36 = flag35 && abs(num742) * 10000.0 < abs(num84) + 1E-06;
                num84 += num742;
                bool flag37 = flag36 && abs(num761) * 10000.0 < abs(num88) + 1E-06;
                num88 += num761;
                bool flag38 = flag37 && abs(num762) * 10000.0 < abs(num115) + 1E-06;
                num115 += num762;
                bool flag39 = flag38 && abs(num763) * 10000.0 < abs(num114) + 1E-06;
                num114 += num763;
                bool flag40 = flag39 && abs(num764) * 10000.0 < abs(num113) + 1E-06;
                num113 += num764;
                bool flag41 = flag40 && abs(num765) * 10000.0 < abs(num112) + 1E-06;
                num112 += num765;
                bool flag42 = flag41 && abs(num786) * 10000.0 < abs(num111) + 1E-06;
                num111 += num786;
                bool flag43 = flag42 && abs(num790) * 10000.0 < abs(num110) + 1E-06;
                num110 += num790;
                bool flag44 = flag43 && abs(num791) * 10000.0 < abs(num109) + 1E-06;
                num109 += num791;
                bool flag45 = flag44 && abs(num792) * 10000.0 < abs(num108) + 1E-06;
                num108 += num792;
                bool flag46 = flag45 && abs(num793) * 10000.0 < abs(num107) + 1E-06;
                num107 += num793;
                bool flag47 = flag46 && abs(num794) * 10000.0 < abs(num106) + 1E-06;
                num106 += num794;
                bool flag48 = flag47 && abs(num795) * 10000.0 < abs(num105) + 1E-06;
                num105 += num795;
                bool flag49 = flag48 && abs(num796) * 10000.0 < abs(num92) + 1E-06;
                num92 += num796;
                bool flag50 = flag49 && abs(num801) * 10000.0 < abs(num103) + 1E-06;
                num103 += num801;
                bool flag51 = flag50 && abs(num805) * 10000.0 < abs(num101) + 1E-06;
                num101 += num805;
                bool flag52 = flag51 && abs(num806) * 10000.0 < abs(num100) + 1E-06;
                num100 += num806;
                bool flag53 = flag52 && abs(num821) * 10000.0 < abs(num94) + 1E-06;
                num94 += num821;
                bool flag54 = flag53 && abs(num822) * 10000.0 < abs(num90) + 1E-06;
                num90 += num822;
                bool flag55 = flag54 && abs(num837) * 10000.0 < abs(num97) + 1E-06;
                num97 += num837;
                bool flag56 = flag55 && abs(num838) * 10000.0 < abs(num93) + 1E-06;
                num93 += num838;
                bool flag57 = flag56 && abs(num839) * 10000.0 < abs(num87) + 1E-06;
                num87 += num839;
                bool flag58 = flag57 && abs(num854) * 10000.0 < abs(num99) + 1E-06;
                num99 += num854;
                bool flag59 = flag58 && abs(num872) * 10000.0 < abs(num96) + 1E-06;
                num96 += num872;
                bool flag60 = flag59 && abs(num873) * 10000.0 < abs(num104) + 1E-06;
                num104 += num873;
                bool flag61 = flag60 && abs(num888) * 10000.0 < abs(num120) + 1E-06;
                num120 += num888;
                bool flag62 = flag61 && abs(num902) * 10000.0 < abs(num98) + 1E-06;
                num98 += num902;
                bool flag63 = flag62 && abs(num906) * 10000.0 < abs(num102) + 1E-06;
                num102 += num906;
                bool flag64 = flag63 && abs(num920) * 10000.0 < abs(num86) + 1E-06;
                num86 += num920;
                bool flag65 = flag64 && abs(num929) * 10000.0 < abs(num95) + 1E-06;
                num95 += num929;
                bool flag66 = flag65 && abs(num935) * 10000.0 < abs(num85) + 1E-06;
                num85 += num935;
                bool flag67 = flag66 && abs(num936) * 10000.0 < abs(num83) + 1E-06;
                num83 += num936;
                bool flag68 = flag67 && abs(num937) * 10000.0 < abs(num80) + 1E-06;
                num80 += num937;
                bool flag69 = flag68 && abs(num939) * 10000.0 < abs(num82) + 1E-06;
                num82 += num939;
                bool flag70 = flag69 && abs(num949) * 10000.0 < abs(num79) + 1E-06;
                num79 += num949;
                bool flag71 = flag70 && abs(num950) * 10000.0 < abs(num77) + 1E-06;
                num77 += num950;
                bool flag72 = flag71 && abs(num953) * 10000.0 < abs(num123) + 1E-06;
                num123 += num953;
                bool flag73 = flag72 && abs(num954) * 10000.0 < abs(num91) + 1E-06;
                num91 += num954;
                bool flag74 = flag73 && abs(num963) * 10000.0 < abs(num81) + 1E-06;
                num81 += num963;
                bool flag75 = flag74 && abs(num970) * 10000.0 < abs(num78) + 1E-06;
                num78 += num970;
                bool flag76 = flag75 && abs(num388) * 10000.0 < abs(num126) + 1E-06;
                num126 += num388;
                bool flag77 = flag76 && abs(num387) * 10000.0 < abs(num128) + 1E-06;
                num128 += num387;
                bool flag78 = flag77 && abs(num386) * 10000.0 < abs(num130) + 1E-06;
                num130 += num386;
                bool flag79 = flag78 && abs(num385) * 10000.0 < abs(num131) + 1E-06;
                num131 += num385;
                bool flag80 = flag79 && abs(num384) * 10000.0 < abs(num132) + 1E-06;
                num132 += num384;
                bool flag81 = flag80 && abs(num383) * 10000.0 < abs(num133) + 1E-06;
                num133 += num383;
                bool flag82 = flag81 && abs(num382) * 10000.0 < abs(num134) + 1E-06;
                num134 += num382;
                bool flag83 = flag82 && abs(num381) * 10000.0 < abs(num135) + 1E-06;
                num135 += num381;
                if (!flag83)
                    --iterations;
                else
        ...
        while (oversample > 0);
        outs[sampleNumber] = d * 1.0;
        if (((sampleNumber & 255) == 0 && (isnan(d) || isinf(d))))
        {
        }
    }
    state[0] = num1;
